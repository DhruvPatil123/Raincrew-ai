...
export default function VoiceSphere({ state, transcriptText }: VoiceSphereProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 sm:p-8 bg-slate-900 rounded-2xl sm:rounded-3xl border border-slate-800 relative overflow-hidden h-72 sm:h-96 shadow-2xl">
      ...
      {/* Main Core Voice Orb */}
      <div className="relative flex items-center justify-center w-36 h-36 sm:w-52 sm:h-52">
        {/* Soft Outer Aura */}
        <motion.div
          animate={{
      ...
      {/* Dynamic Subtext Bar */}
      <div className="mt-4 sm:mt-8 z-10 max-w-md text-center h-20 flex flex-col justify-center">
        {state === 'speaking' && (
